...
<div style="display: flex; align-items: left; justify-content: left; width: 100%; height: 100%;">
    <div style="display: flex; align-items: center; border-radius: 5px; padding: 10px;">
        ...
        <div>
            <div style="font-weight: bold; margin-bottom: 5px;">Yanchen Liu</div>
            <div style="margin-bottom: 5px;">📧 jamesnulliu@gmail.com</div>
            <div style="margin-bottom: 5px;">📞 (+86) 189-173-18020</div>
            <div>
